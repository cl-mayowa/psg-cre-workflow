...
func (c *IERC20) RegisterLogTrackingApproval(runtime cre.Runtime, options *bindings.LogTrackingOptions[Approval]) cre.Promise[*emptypb.Empty] {
...
func (c *IERC20) UnregisterLogTrackingApproval(runtime cre.Runtime) cre.Promise[*emptypb.Empty] {
...
func (c *IERC20) RegisterLogTrackingTransfer(runtime cre.Runtime, options *bindings.LogTrackingOptions[Transfer]) cre.Promise[*emptypb.Empty] {
...
func (c *IERC20) UnregisterLogTrackingTransfer(runtime cre.Runtime) cre.Promise[*emptypb.Empty] {
	return c.client.UnregisterLogTracking(runtime, &evm.UnregisterLogTrackingRequest{
