...
func (c *ReserveManager) RegisterLogTrackingRequestReserveUpdate(runtime cre.Runtime, options *bindings.LogTrackingOptions[RequestReserveUpdate]) cre.Promise[*emptypb.Empty] {
...
func (c *ReserveManager) UnregisterLogTrackingRequestReserveUpdate(runtime cre.Runtime) cre.Promise[*emptypb.Empty] {
