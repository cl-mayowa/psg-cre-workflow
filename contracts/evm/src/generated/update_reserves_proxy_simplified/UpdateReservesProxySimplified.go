...
// Main Binding Type for UpdateReservesProxySimplified
type UpdateReservesProxySimplified struct {
	Address []byte
	Options *bindings.ContractInitOptions
	ABI     *abi.ABI
	client  *evm.Client
	Codec   UpdateReservesProxySimplifiedCodec
}

type UpdateReservesProxySimplifiedCodec interface {
...
func NewUpdateReservesProxySimplified(
	client *evm.Client,
	address []byte,
	options *bindings.ContractInitOptions,
) (*UpdateReservesProxySimplified, error) {
	parsed, err := abi.JSON(strings.NewReader(UpdateReservesProxySimplifiedMetaData.ABI))
	if err != nil {
		return nil, err
	}
	codec, err := NewCodec()
	...
	return &UpdateReservesProxySimplified{
		Address: address,
		Options: options,
		ABI:     &parsed,
		client:  client,
...
func NewCodec() (UpdateReservesProxySimplifiedCodec, error) {
	parsed, err := abi.JSON(strings.NewReader(UpdateReservesProxySimplifiedMetaData.ABI))
	if err != nil {
		return nil, err
	}
...
func (c UpdateReservesProxySimplified) EXPECTEDAUTHOR(
	runtime cre.Runtime,
	blockNumber *big.Int,
...
func (c UpdateReservesProxySimplified) EXPECTEDWORKFLOWNAME(
	runtime cre.Runtime,
	blockNumber *big.Int,
) cre.Promise[*evm.CallContractReply] {
...
func (c UpdateReservesProxySimplified) ReserveManager(
	runtime cre.Runtime,
	blockNumber *big.Int,
) cre.Promise[*evm.CallContractReply] {
...
func (c UpdateReservesProxySimplified) WriteReport(
	runtime cre.Runtime,
	report *cre.Report,
...
func (c *UpdateReservesProxySimplified) DecodeInvalidAuthorError(data []byte) (*InvalidAuthor, error) {
...
func (c *UpdateReservesProxySimplified) DecodeInvalidWorkflowNameError(data []byte) (*InvalidWorkflowName, error) {
...
func (c *UpdateReservesProxySimplified) UnpackError(data []byte) (any, error) {
