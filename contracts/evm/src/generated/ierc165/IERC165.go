...
func NewIERC165(
	...
	parsed, err := abi.JSON(strings.NewReader(IERC165MetaData.ABI))
	if err != nil {
		return nil, err
	}
	codec, err := NewCodec()
...
func NewCodec() (IERC165Codec, error) {
	parsed, err := abi.JSON(strings.NewReader(IERC165MetaData.ABI))
	if err != nil {
		return nil, err
	}
...
func (c IERC165) SupportsInterface(
	runtime cre.Runtime,
...
func (c *IERC165) UnpackError(data []byte) (any, error) {
